...
const TextureArtSection = () => {
  return (
    ...
    <div className="texture-section">
      ...
      <p>
      Bringing Depth and Dimension to Creativity
      </p>
      <p>
          ...
          <ul className="reasons-list">
            <li>
              ...
              <div>
                ...
                <p>Every texture artwork is distinct, offering a rich, dynamic feel.
                The intricate layers and tactile elements bring each piece to life, sparking curiosity and emotional connection.</p>
              </div>
            </li>
            <li>
            <img src={star} className='icons'/>
              ...
              <div>
                ...
                <p>The interplay of light and shadow makes textured art visually stunning.
                Its multidimensional surface draws the eye from every angle, creating an ever-evolving visual experience.</p>
              </div>
            </li>
            <li>
            <img src={star} className='icons'/>
              ...
              <div>
                ...
                <p>Unlike flat paintings, texture art invites touch, creating an immersive experience.
                The raised surfaces and varied materials engage the senses, making the viewer feel more connected to the artwork.</p>
              </div>
            </li>
            <li>
            <img src={star} className='icons'/>
              ...
              <div>
                ...
                <p>Adds elegance and personality to homes, offices, and commercial spaces.
                  Its unique textures serve as conversation starters and elevate the ambiance of any interior.</p>
              </div>
            </li>
          </ul>
        </div>
      ...
      <div className="creations-text">
        ...
        <ul className="creation-list">
          ...
          <img src={check} className='icons_check'/>
            ...
            <strong>Acrylic Texture Paintings</strong> - Vibrant, textured artworks with intricate layering.
          </li>
          <li>
          <img src={check} className='icons_check'/>
            <strong>Mixed Media Art</strong> - A blend of different materials to create striking effects.
          </li>
          <li>
          <img src={check} className='icons_check'/>

            <strong>3D Wall Art</strong> - Bold and sculptural pieces that transform any space.
          </li>
          <li>
          <img src={check} className='icons_check'/>

            <strong>Custom Texture Designs</strong> - Personalized artwork tailored to your style.
          </li>
        </ul>
