...
const ResignArt = () => {
  return (
    ...
    <div className="texture-section">
      ...
      <p>
      Turning Imagination into Glossy Reality
      </p>
      <p>
      Resin Art merges craftsmanship with innovation to create mesmerizing, glass-like finishes and dynamic 3D effects. Whether it’s ocean waves, abstract pours, or embedded elements, each piece is handcrafted with precision and creativity.
      </p>
    </div>
    <div className="texture-container">
      ...
      <div className="texture-content">
        <img src={image1} alt="Texture Art" className="resign-image" />
          ...
          <ul className="reasons-list">
            ...
            <img src={star} className='icons'/>
              ...
              <div>
                ...
                <p>Every piece reduces waste and promotes a greener planet.
                It encourages mindful living by turning discarded items into lasting beauty.
                Resign Art serves as a creative reminder that art can drive positive environmental change.
                </p>
              </div>
            </li>
            <li>
            <img src={star} className='icons'/>
              ...
              <div>
                ...
                <p>No two pieces are ever the same, making them truly one-of-a-kind.
                Each creation carries its own story, shaped by the materials and the artist’s vision.
                This individuality adds character and depth, making every artwork a personal statement.</p>
              </div>
            </li>
            <li>
            <img src={star} className='icons'/>
              ...
              <div>
                ...
                <p>Our art is not just visually appealing but also carries an eco-conscious message.
                It challenges traditional notions of beauty by embracing reclaimed materials.
                Through each piece, we aim to inspire sustainability, innovation, and thoughtful living.</p>
              </div>
            </li>
          </ul>
        </div>
      ...
      <div className="creations-text">
        ...
        <ul className="creation-list">
          ...
          <img src={check} className='icons_check'/>
            ...
            <strong>Upcycled Sculptures</strong> - Turning scrap materials into breathtaking art pieces.
          </li>
          <li>
          <img src={check} className='icons_check'/>

            <strong>Mixed Media ArtEco-Friendly Home Décor</strong> - Unique, handcrafted items that add charm to any space.
          </li>
          <li>
          <img src={check} className='icons_check'/>

            <strong>Custom Creations</strong> - Personalized artwork made from repurposed materials.
          </li>
          <li>
          <img src={check} className='icons_check'/>

            <strong>Workshops & Awareness</strong> - Educating communities on sustainable art practices.
          </li>
        </ul>

        <h3>Discover the Beauty of Resign Art</h3>
        <p>
        Be a part of the sustainable art revolution! Whether you're an art lover, a collector, or someone who believes in environmental responsibility, Resign Art is for you. Explore our collection and discover the beauty of upcycled art.
        </p>
      </div>
    </div>
      </div>
